...
import { ChevronLeft, User, Calendar, Phone, Activity, FileText, Plus, ImageIcon, Upload, FlaskConical } from 'lucide-react';
                    ...
                    >
                        <div className="flex items-center gap-4 mb-6">
                            ...
                            <div>
                                ...
                                <p className="text-gray-400">ID: PT-{patient.id}</p>
                            </div>
                        </div>
                        ...
                        {studies.length === 0 ? (
                            ...
                            <div className="space-y-4">
                                {studies.map((study, idx) => (
                                    <div key={idx} className="bg-black/30 border border-white/5 rounded-xl p-5 flex items-center justify-between hover:border-blue-500/30 transition-colors">
                                        <div className="flex items-center gap-5">
                                            <div className="w-12 h-12 bg-blue-900/40 rounded-lg flex items-center justify-center text-blue-400 font-bold tracking-wider">
                                                {study.modality || 'MRI'}
                                            </div>
                                            <div>
                                        ...
                                        <button 
                                            ...
                                            className="px-5 py-2.5 bg-blue-600/10 hover:bg-blue-600/20 text-blue-400 border border-blue-500/20 rounded-lg font-medium transition-all"
                                        >
                                            Open Viewer
                                        </button>
                                    </div>
